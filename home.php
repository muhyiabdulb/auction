                                    ...
                                    <div class="float-right align-top bid-tag">
                                     ...
                                     <img class="card-img-top" src="admin/assets/uploads/<?php echo $row['img_fname'] ?>" alt="Card image cap">
                                      <div class="float-right align-top d-flex">
                                         <span class="badge badge-pill badge-warning text-white"><i class="fa fa-hourglass-half"></i> <?php echo date("d M Y - H:i A",strtotime($row['bid_end_datetime'])) ?></span>
                                     </div>
                                     <div class="card-body prod-item">
                                         <p><?php echo $row['name'] ?></p>
                                         <p><small class="text-primary">Categories: <?php echo $cat_arr[$row['category_id']] ?></small></p>
                                         <p class="mt-3 truncate"><?php echo $row['description'] ?></p>
                                        <button class="mt-3 btn btn-primary btn-md btn-block view_prod" type="button" data-id="<?php echo $row['id'] ?>"> View</button>
                                     </div>
                                 </div>
                             </div>
                            <?php endwhile; ?>
